...
#include "JohnsonJacksonParticleThetaVibrationFvPatchScalarField.H"
...
namespace Foam
{
    ...
    (
        fvPatchScalarField,
        JohnsonJacksonParticleThetaVibrationFvPatchScalarField
    );
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

Foam::JohnsonJacksonParticleThetaVibrationFvPatchScalarField::
JohnsonJacksonParticleThetaVibrationFvPatchScalarField
(
    const fvPatch& p,
...
JohnsonJacksonParticleThetaVibrationFvPatchScalarField
(
    const JohnsonJacksonParticleThetaVibrationFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::JohnsonJacksonParticleThetaVibrationFvPatchScalarField::autoMap
(
...
void Foam::JohnsonJacksonParticleThetaVibrationFvPatchScalarField::rmap
(
...
void Foam::JohnsonJacksonParticleThetaVibrationFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    dimensionedScalar rmsVelocity
    (
        amplitude*2.0*constant::mathematical::pi*frequency/sqrt(2.0)
    ); 
    
    // lookup the flow density
    dimensionedScalar flowDensity
    (
        "flowDensity",
        dimless,
        db()
    ...
    else
    {
        ...
        this->refGrad() =
           ...
           *alpha
           *gs0
           *(sqr(rmsVelocity.value())*sqrt(Theta + sqr(rmsVelocity.value())))
           /(sqrt(constant::mathematical::pi)*kappa, SMALL);
...
void Foam::JohnsonJacksonParticleThetaVibrationFvPatchScalarField::write
(
    Ostream& os
) const
{
